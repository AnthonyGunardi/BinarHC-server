...
route.post('/user', authentication, AttendanceController.clockInByAdmin);
...
route.get('/report', authentication, AttendanceController.getAttendancesReport); //with query params, example: ?start_date=2024-10-21&end_date=2024-10-23&division_slug=cia&status=WFO&NIP=BINAR00004
